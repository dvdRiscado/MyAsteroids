class Scene2 extends SimpleScene {
  ...
  preload() {
    ...
    this.load.image('AsteroidPq', 'assets/img/Final - AsteroidPq.png');
    this.load.image('AsteroidMd', 'assets/img/Final - AsteroidMd.png');
    this.load.image('AsteroidGr', 'assets/img/Final - AsteroidGr.png');
  }
  ...
  create() {    
    ...
    // Criar Título
    this.titulo = this.add.text(960, 510, 'Asteroids').setOrigin(0.5, 0.5).setFontSize(120).setFontFamily('super-Mario-Bros');
  ...
  asteroidPequeno(){
    ...
    let pequeno = this.physics.add.sprite(this.minX, y, 'AsteroidPq').setScale(1.0); // Criando o Asteroide
  ...
  asteroidMedio(){
    let y = random(0, 500);
    let medio = this.physics.add.sprite(this.maxX, y, 'AsteroidMd').setScale(1.0);
  ...
  asteroidGrande(){
    let y = random(0, 500);
    let grande = this.physics.add.sprite(this.maxX, y, 'AsteroidGr').setScale(1.0);
